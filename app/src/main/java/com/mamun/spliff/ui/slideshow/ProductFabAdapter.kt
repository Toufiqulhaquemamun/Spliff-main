...
class ProductFabAdapter(private val prodList: List<Product>?) :
    RecyclerView.Adapter<ProductFabAdapter.MyViewHolder>() {


    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ProductFabAdapter.MyViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_prod_info, parent, false)
        return MyViewHolder(view)
    }

    override fun onBindViewHolder(holder: ProductFabAdapter.MyViewHolder, position: Int) {
